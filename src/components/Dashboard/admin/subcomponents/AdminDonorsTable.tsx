...
const AdminDonorsTable : React.FC<AdminDonorTableProps> = ({ donors, onRefetch}) => {
                  ...
                  >
                    ...
                    />
                      ...
                      <Typography variant="h6">
                        <strong>Donor Name:</strong> {selectedDonor?.donor.firstName} {selectedDonor?.donor.lastName}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Blood Group:</strong> {selectedDonor?.bloodGroup?.groupName}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Email:</strong> {selectedDonor?.donor.email}
                      </Typography>
                      <Typography variant="body1">
                        <strong>Contact Number:</strong> {selectedDonor?.donor.contactNumber}
                      </Typography>
                      <Typography variant="body1">
                      ...
                      <Typography variant="body1">
                        <strong>Birth Date:</strong> {selectedDonor?.donor.dateOfBirth?.toString()}
                      </Typography>
                    </div> 
                </Box>
               </Box>
