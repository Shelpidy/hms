...
const AdminRequirersTable : React.FC<AdminRequirerTableProps> = ({ requirers, onRefetch}) => {
    ...
    return (
        ...
        <TableBody>
            {requirers
                  .filter(requirer => 
                    requirer.user.email.includes(searchQuery)                
                    )
                  .map((requirer, index) => 
                  <TableRow key={index}>
                    <TableCell>{requirer?.user?.email}</TableCell>
                    <TableCell>{requirer?.user?.address}</TableCell>
                    <TableCell>{requirer?.requirer?.createdAt.toString()}</TableCell>
                    <TableCell>
                       ...
                       <IconButton onClick={() => handleDelete(requirer.requirer.requirerId)}>
                        <Delete />
                      </IconButton>
                    </TableCell>               
                  </TableRow> 
               ...
               >
                    ...
                    />
                      ...
                      <Typography variant="h6">
                        <strong>Requirer Name:</strong> {selectedRequirer?.user.firstName} {selectedRequirer?.user.lastName}
                      </Typography>
                      ...
                      <Typography variant="body1">
                        <strong>Birth Date:</strong> {selectedRequirer?.user?.dateOfBirth?.toString()}
                      </Typography>
                    </div>    
                </Box>
             </Box>
